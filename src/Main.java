import ru.cherevicheko.task2.RunTask2;
import ru.cherevichenko.task1.Employee;
import ru.cherevichenko.task1.RunTask1;
...
public class Main {
    public static void main(String[] args) {
       ...
       try {
           ...
           System.out.println("Вы ввели нне число!");
       }
       switch (number){
           case 1:
